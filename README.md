...
A CLI-based AI coding agent built with Python and Google Gemini. The agent operates in an agentic loop — planning, calling tools, observing results, and iterating — until it completes a task or hits a safety limit.
